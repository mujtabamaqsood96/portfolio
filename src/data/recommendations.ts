export type Recommendation = {
  ...
  /** Optional short credibility line (previous industry background). */
...
export const recommendations: Recommendation[] = [
  {
    ...
    experienceLine: "19+ years in Intel engineering and customer-enablement roles.",
  ...
  },
  {
    ...
    experienceLine:
      "14+ years across Intel, National Instruments, and Lattice in firmware, FPGA hardware, and industrial/automotive systems leadership.",
  ...
  },
  {
    ...
    experienceLine:
      "20+ years across Lattice and software-intelligence leadership roles in FAE, strategic accounts, and business development.",
  ...
  },
  {
    ...
    experienceLine:
      "PhD in IT with 17+ publications, ML/AI research and training experience, and international editorial/reviewer roles.",
